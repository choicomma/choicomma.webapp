...
export default async function ShopLayout({
  ...
  return (
    <PageLayout>
      <ProductsProvider>
        <div className="flex flex-col md:grid grid-cols-12 md:gap-sides items-start pb-20 md:pb-32">
          <DesktopFilters
          ...
          <div className="col-span-9 h-full md:pt-top-spacing pb-16 md:pb-24">
